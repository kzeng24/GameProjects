...
public interface IViewModel {
  ...
  /**
   * Retrieves the required length in a guess. It is the number of colors that the user must input
   * to make a complete guess.
   *
  ...
  /**
   * Determines whether the user wins a game. If the user is able to successfully create a guess
   * that matches the answer key before they use up all their guesses, they will win. If winGame
   * returns false, it means that the user can either continue guessing or that they lost, depending
   * on if they still have guesses remaining.
   *
