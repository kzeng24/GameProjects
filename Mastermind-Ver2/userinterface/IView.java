...
public interface IView {
  ...
  /**
   * Draws the rows stacked onto each other (from bottom to top),
   * creating space for potential guesses.
   ...
   */
  WorldScene lastScene(String msg) throws IllegalArgumentException;
